...
public class SenateEvacuation {
        ...
        for (int t = 1; t <= T; t++) {
            ...
            while(senatorsCount > 0) {
                ...
                if(maxInteger == 1) {
                    ...
                    senatorsCount--;
                    System.out.printf("%s", partyIdToLetter(indexOfMax));
                    if(P.stream().filter(integer -> integer == 1).count() < 2) {
                        ...
                        System.out.printf("%s", partyIdToLetter(indexOfMax2));
                        senatorsCount--;
                    }
                } else {
                    P.set(indexOfMax, maxInteger - 1);
    ...
    public static String partyIdToLetter(final int partyId) {
        return String.valueOf((char)('A' + partyId));
    }
